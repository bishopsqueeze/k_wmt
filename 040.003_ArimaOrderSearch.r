...
fourierOrderArima.list <- foreach(i=1:numTestSd) %dopar% {
	...
	## basic  projection
	##------------------------------------------------------------------
	if ( (tmp.store > 0) & (tmp.dept %in% c(12, 20, 21, 22, 24, 25, 26, 28, 30, 31, 33)) ) {
		if (num.obs >= minObs) {
...
## Save image
##------------------------------------------------------------------
save(list.names, list.k, aic.mat, fourierOrderArima.list, file="040.003_ArimaOrderSearch_Dept12.20.21.22.24.25.26.28.30.31.33.Rdata")
