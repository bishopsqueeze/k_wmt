...
S011_HistoryAndProjection <- hp
save(S011_HistoryAndProjection, file="S011_HistoryAndProjection.Rdata")
...
write.csv(res, file="S011_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S011_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S011_Submission.Rdata")
