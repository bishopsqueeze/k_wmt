...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S026_20140405.Rdata")
...
S026_HistoryAndProjection <- hp
save(S026_HistoryAndProjection, file="S026_HistoryAndProjection.Rdata")
...
write.csv(res, file="S026_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S026_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S026_Submission.Rdata")
