...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S025_20140405.Rdata")
...
S025_HistoryAndProjection <- hp
save(S025_HistoryAndProjection, file="S025_HistoryAndProjection.Rdata")
...
write.csv(res, file="S025_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S025_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S025_Submission.Rdata")
