...
S017_HistoryAndProjection <- hp
save(S017_HistoryAndProjection, file="S017_HistoryAndProjection.Rdata")
...
write.csv(res, file="S017_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S017_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S017_Submission.Rdata")
