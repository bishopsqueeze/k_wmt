...
S018_HistoryAndProjection <- hp
save(S018_HistoryAndProjection, file="S018_HistoryAndProjection.Rdata")
...
write.csv(res, file="S018_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S018_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S018_Submission.Rdata")
