...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S028_20140405.Rdata")
...
S028_HistoryAndProjection <- hp
save(S028_HistoryAndProjection, file="S028_HistoryAndProjection.Rdata")
...
write.csv(res, file="S028_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S028_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S028_Submission.Rdata")
