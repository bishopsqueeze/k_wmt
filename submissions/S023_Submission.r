...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S023_20140405.Rdata")
...
S023_HistoryAndProjection <- hp
save(S023_HistoryAndProjection, file="S023_HistoryAndProjection.Rdata")
...
write.csv(res, file="S023_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S023_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S023_Submission.Rdata")
