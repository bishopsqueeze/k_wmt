...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_20140326.Rdata")
...
S012_HistoryAndProjection <- hp
save(S012_HistoryAndProjection, file="S012_HistoryAndProjection.Rdata")
...
write.csv(res, file="S012_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S012_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S012_Submission.Rdata")
