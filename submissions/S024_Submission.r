...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S024_20140405.Rdata")
...
S024_HistoryAndProjection <- hp
save(S024_HistoryAndProjection, file="S024_HistoryAndProjection.Rdata")
...
write.csv(res, file="S024_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S024_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S024_Submission.Rdata")
