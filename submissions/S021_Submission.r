...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S020_20140403.Rdata")
...
S021_HistoryAndProjection <- hp
save(S021_HistoryAndProjection, file="S021_HistoryAndProjection.Rdata")
...
write.csv(res, file="S021_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S021_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S021_Submission.Rdata")
