...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S027_20140405.Rdata")
...
S027_HistoryAndProjection <- hp
save(S027_HistoryAndProjection, file="S027_HistoryAndProjection.Rdata")
...
write.csv(res, file="S027_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S027_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S027_Submission.Rdata")
