...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S014_20140331.Rdata")
...
S014_HistoryAndProjection <- hp
save(S014_HistoryAndProjection, file="S014_HistoryAndProjection.Rdata")
...
write.csv(res, file="S014_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S014_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S014_Submission.Rdata")
