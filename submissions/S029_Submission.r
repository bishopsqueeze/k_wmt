...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S029_20140405.Rdata")
...
S029_HistoryAndProjection <- hp
save(S029_HistoryAndProjection, file="S029_HistoryAndProjection.Rdata")
...
write.csv(res, file="S029_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S029_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S029_Submission.Rdata")
