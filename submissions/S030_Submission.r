...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S030_20140405.Rdata")
...
S030_HistoryAndProjection <- hp
save(S030_HistoryAndProjection, file="S030_HistoryAndProjection.Rdata")
...
write.csv(res, file="S030_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S030_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S030_Submission.Rdata")
