...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S032_20140405.Rdata")
...
S032_HistoryAndProjection <- hp
save(S032_HistoryAndProjection, file="S032_HistoryAndProjection.Rdata")
...
write.csv(res, file="S032_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S032_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S032_Submission.Rdata")
