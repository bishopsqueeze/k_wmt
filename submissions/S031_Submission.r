...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S031_20140405.Rdata")
...
S031_HistoryAndProjection <- hp
save(S031_HistoryAndProjection, file="S031_HistoryAndProjection.Rdata")
...
write.csv(res, file="S031_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S031_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S031_Submission.Rdata")
