...
S020_HistoryAndProjection <- hp
save(S020_HistoryAndProjection, file="S020_HistoryAndProjection.Rdata")
...
write.csv(res, file="S020_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S020_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S020_Submission.Rdata")
