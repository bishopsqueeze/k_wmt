...
## Load fit results
##------------------------------------------------------------------
load("999_CompareModels_S015_20140401.Rdata")
...
S019_HistoryAndProjection <- hp
save(S019_HistoryAndProjection, file="S019_HistoryAndProjection.Rdata")
...
write.csv(res, file="S019_Submission.csv", row.names=FALSE)
...
write.csv(misses.df, file="S019_Misses.csv")


##------------------------------------------------------------------
## Save the workspace
##------------------------------------------------------------------
save.image(file="S019_Submission.Rdata")
